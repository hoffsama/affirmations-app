...
function prinntWelcomeMessage() {
    ...
    console.log('(a) Veiw an affirmation');
...
function printAffirmationAndOptions(){
    ...
    console.log('');
    console.log('(a) Veiw an affirmation. NOTE: This is pure random so you may see affirmations you have already seen before affirmations you have not seen yet');
